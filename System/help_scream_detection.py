...
Original file is located at
    https://colab.research.google.com/drive/17pQ5SAxHIIKi9Ttbmcl6_hagxhhmcXf1
"""
...
# 탐지할 키워드 정의
keywords = ["help", "please help", "help me", "도와줘", "도와주어", "도와주세요"]
...
def process_audio_file(file_path, model, threshold=0.5):
    ...
    try:
        ...
        # Screaming 여부 시각화
        plt.subplot(2, 1, 2)
        plt.bar(["Not Screaming", "Screaming"], [1 - int(is_screaming), int(is_screaming)], color=['gray', 'red'])
        plt.title("Screaming Detection")
        plt.ylim(0, 1)
        plt.tight_layout()
        plt.show()
...
if __name__ == "__main__":
    try:
        ...
        # 음성 녹음
        recorded_audio_path = record_audio(duration=2, sampling_rate=44100)

        # Screaming 여부 판단
        s_bool = process_audio_file(recorded_audio_path, model)
